...
const Services = () => {
  ...
  return (
    <div>
      {showHeader && (
        <header
          className="fixed top-0 left-0 right-0 flex justify-around gap-9 bg-opacity-50 text-white bg-sky-950 p-4 z-20 backdrop-blur-md transition-opacity duration-300 ease-in-out"
          data-aos="zoom-out"
        >
      ...
      <div>
        <div className="h-screen overflow-hidden bg-white flex flex-col items-center rounded-t-3xl relative ">
          <h1
          ...
          <div className="flex justify-evenly w-full">
            <div className="flex flex-col items-center text-center w-1/4">
              ...
              <p
                data-aos="fade-up"
                data-aos-anchor-placement="bottom-bottom"
                className="text-sm font-raleway font-normal "
              >
        ...
        <div className="h-screen w-full  bg-white flex flex-col items-center cursor-pointer">
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(to right, rgba(3, 18, 36, 0.9) 50%, rgba(3, 18, 36, 0))",
              }}
            />
            <div className="relative z-20 p-4 ml-52">
              <h1
                className="text-white text-3xl tracking-wider cursor-pointer transition-all duration-500 ease-in-out opacity-100 hover:opacity-0"
                data-aos="zoom-out"
              >
                Decor Guidance
              </h1>
              <div className="hidden-content opacity-0 invisible transition-all duration-500 ease-in-out font-raleway">
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(to right, rgba(3, 18, 36, 0) , rgba(3, 18, 36, 0.9) 50%)",
              }}
            />
            <div className="relative z-20 p-4 mr-44">
              <h1
                className="text-white text-3xl cursor-pointer transition-all duration-500 ease-in-out opacity-100 hover:opacity-0 tracking-wider"
                data-aos="zoom-out"
              >
                Intentional Layout
              </h1>
          ...
          >
            ...
            <div className="w-full flex justify-end relative ">
              ...
              >
                ...
                <div className="absolute inset-0 bg-sky-950 opacity-70" />
          ...
          <div className="bg h-full flex justify-center items-center">
            <div className="h-3/4 w-10/12 bg-white flex">
              <div className="w-2/5 h-full relative flex justify-center items-center">
                <div className="absolute inset-0 bg-sky-950 opacity-80 z-20 pointer-events-none"></div>
                <div
                ...
                {slides
                  ...
                  .map((slide) => (
                    ...
                    >
                      ...
                      <p className="text-sm tracking-widest font-raleway">
                        {slide.content}
                      </p>
                    </div>
                  ))}
      ...
      <div>
        <div className="h-screen bg-white flex flex-col items-center text-center pt-20">
          ...
          <p
            className="w-3/4 tracking-wide mb-7 font-raleway"
            data-aos="fade-up"
            data-aos-anchor-placement="bottom-bottom"
          >
          ...
          <div className="w-3/4 h-80 flex justify-around items-center gap-4">
            ...
            >
              <div className="relative w-full h-16 overflow-hidden">
                ...
                <div className="absolute top-0 left-0 w-full h-full bg-sky-950 opacity-50" />

                <h1 className="relative font-bold text-sm text-white z-10 w-full flex justify-center mt-6">
                  Local Exposure
                </h1>
              </div>
              <p className="text-sm tracking-wide text-justify font-raleway">
          ...
          <div className="w-3/6 ">
            <ul className="bg-first flex flex-col justify-center items-center text-center">
              <li className="flex flex-col items-center text-center w-2/4 -ml-32 mb-10">
                ...
                <p
                  className="tracking-widest text-sm font-raleway"
                  data-aos="fade-right"
                >
      ...
      <div>
        <div className="bg-contact relative bg-white">
          <div
            className="absolute inset-0 bg-sky-950 opacity-80 z-10"
            style={{
          ...
          <div className="relative h-3/4 flex flex-col justify-center items-center z-10">
            ...
            <p
              className="font-thin tracking-widest text-white w-2/4 text-xs text-center font-raleway"
              data-aos="fade-up"
            >
